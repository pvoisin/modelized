...
var Registry = require("../../source/Registry");
...
describe("Registry", function() {
	it("should provide a collection of objects", function() {
		...
		expect(Thing.dispose(thing1)).to.be(true);
		expect(Registry.getOwnScope(Thing).objects.length).to.be(1);
		expect(Thing.get(0)).to.be(thing2);
